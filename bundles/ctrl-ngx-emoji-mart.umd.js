(function (global, factory) {
  ...
  var EmojiFrequentlyService = /** @class */ (function () {
      ...
      EmojiFrequentlyService.prototype.init = function (isLocalStorageAccessible, storageObject) {
          if (isLocalStorageAccessible === void 0) { isLocalStorageAccessible = true; }
          if (storageObject === void 0) { storageObject = {}; }
      ...
      EmojiFrequentlyService.prototype.add = function (emoji, isLocalStorageAccessible, storageObject) {
          if (isLocalStorageAccessible === void 0) { isLocalStorageAccessible = true; }
          if (storageObject === void 0) { storageObject = {}; }
          if (!this.initialized) {
      ...
      EmojiFrequentlyService.prototype.get = function (perLine, totalLines, isLocalStorageAccessible, storageObject) {
          var _this = this;
          if (isLocalStorageAccessible === void 0) { isLocalStorageAccessible = true; }
          if (storageObject === void 0) { storageObject = {}; }
          if (!this.initialized) {
  ...
  var CategoryComponent = /** @class */ (function () {
      ...
      CategoryComponent.prototype.getEmojis = function () {
          var _this = this;
          if (this.name === 'Recent') {
              var frequentlyUsed = this.recent || this.frequently.get(this.perLine, this.totalFrequentLines, this.isLocalStorageAccessible, this.storageObject);
  ...
  CategoryComponent.propDecorators = {
      ...
      isLocalStorageAccessible: [{ type: i0.Input }],
      storageObject: [{ type: i0.Input }],
  ...
  ***************************************************************************** */
  ...
  var EmojiSearch = /** @class */ (function () {
      function EmojiSearch(emojiService) {
          ...
          var this_1 = this;
          try {
              for (var _c = __values(this.emojiService.emojis), _d = _c.next(); !_d.done; _d = _c.next()) {
          ...
          if (value.length) {
              ...
              if (include.length || exclude.length) {
                  ...
                  i1.categories.forEach(function (category) {
                      ...
                      (_a = category.emojis) === null || _a === void 0 ? void 0 : _a.forEach(function (emojiId) {
                          var _a;
              ...
              allResults = values
                  ...
                  var _loop_2 = function (charIndex) {
                      ...
                      if (!aIndex.results) {
                          ...
                          aIndex.pool = {};
                          try {
                              for (var _c = (e_2 = void 0, __values(Object.keys(aPool))), _d = _c.next(); !_d.done; _d = _c.next()) {
                                  var id = _d.value;
                                  var emoji = aPool[id];
  ...
  var PickerComponent = /** @class */ (function () {
      function PickerComponent(ref, frequently) {
          ...
          this.backgroundImageFn = function (set, sheetSize) { return "https://unpkg.com/emoji-datasource-" + _this.set + "@5.0.1/img/" + _this.set + "/sheets-256/" + _this.sheetSize + ".png"; };
      }
